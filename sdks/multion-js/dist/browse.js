...
var _multionJs = _interopRequireDefault(require("multion-js"));
...
class MultionToolSpec {
  constructor(tokenFile = "multion_token.txt", defaultUrl = "https://google.com", mode = "auto") {
    this.multion = new _multionJs.default(tokenFile);
    this.multion.login();
