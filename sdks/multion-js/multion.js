  ...
  async getScreenshot(response, height = null, width = null) {
    ...
    try {
      ...
      if (height !== null && width !== null) {
        resizedBuffer = await sharp(imgBuffer).resize(width, height).png().toBuffer();
      } else if (height !== null) {
        resizedBuffer = await sharp(imgBuffer).resize({ height }).png().toBuffer();
      } else if (width !== null) {
        resizedBuffer = await sharp(imgBuffer).resize({ width }).png().toBuffer();
      } else {
